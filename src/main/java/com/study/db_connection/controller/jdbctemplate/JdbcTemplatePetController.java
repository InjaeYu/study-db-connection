...
import com.study.db_connection.service.jdbctemplate.JdbcTemplatePetService;
...
@RequestMapping("/jdbc-template/pets")
public class JdbcTemplatePetController {

    private final JdbcTemplatePetService service;
    ...
    public ResponseEntity<ResponseDto> save(@RequestBody PetSaveDto requestBody) {
        ...
        Pet savedPet = service.save(requestBody.getMemberId(), pet);
    ...
    public ResponseEntity<ResponseDto> findById(@PathVariable("id") Long id) {
        Pet findPet = service.findById(id);
    ...
    public ResponseEntity<ResponseDto> update(@PathVariable("id") Long id,
        ...
        Pet updatedPet = service.update(requestBody.getMemberId(), pet);
